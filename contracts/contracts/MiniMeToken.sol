...
///////////////////
    ...
    function transfer(address _to, uint256 _amount) returns (bool success) {
        ...
        return transferExt(_to, _amount, b);
    }
    ...
    function transferFrom(address _from, address _to, uint256 _amount
        ...
        bytes memory b = new bytes(0);
        return transferFromExt(_from,  _to, _amount, b);
    }
    ...
    /// @param _amount The amount of tokens to be transferred
    /// @return Whether the transfer was successful or not
    function transferExt(address _to, uint256 _amount, bytes _ext) returns (bool success) {
        if (!transfersEnabled) throw;
        return doTransfer(msg.sender, _to, _amount, _ext);
    }
    ...
    /// @param _amount The amount of tokens to be transferred
    /// @return True if the transfer was successful
    function transferFromExt(address _from, address _to, uint256 _amount, bytes _ext
    ) returns (bool success) {
        ...
        return doTransfer(_from, _to, _amount, _ext);
    }
    ...
    /// @param _amount The amount of tokens to be transferred
    /// @return True if the transfer was successful
    function doTransfer(address _from, address _to, uint _amount, bytes _ext
           ...
           if (isContract(controller)) {
               if (!TokenController(controller).onTransfer(_from, _to, _amount, _ext))
               throw;
           }
           ...
           TransferExt(_from, _to, _amount, _ext);
